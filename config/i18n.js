...
const MESSAGES = {
  ...
  ms: {
    ...
    'user.withdrawNotifMsg': (amount) => `Permintaan pengeluaran sebanyak Rp${Number(amount).toLocaleString('id-ID')} sedang menunggu pengesahan admin.`,
    ...
    'admin.balanceNotifMsg': (balance) => `Baki anda telah dikemas kini oleh admin kepada Rp${Number(balance).toLocaleString('id-ID')}`,
